...
def unet(inputI, output_channel):
    ...
    conv1_relu = relu(conv1_bn, name='conv1_relu')

    pool1_in = MaxPooling3D(
    ...
    conv3_1_relu = relu(conv3_1_bn, name='conv3_1_relu')
    conv3_2 = conv3d(
        input=conv3_1_relu,
        output_chn=256,
        kernel_size=3,
    ...
    conv3_2_relu = relu(conv3_2_bn, name='conv3_2_relu')

    pool3_in = MaxPooling3D(
    ...
    conv4_1_relu = relu(conv4_1_bn, name='conv4_1_relu')
    conv4_2 = conv3d(
        input=conv4_1_relu,
        output_chn=512,
        kernel_size=3,
    ...
    conv4_2_relu = relu(conv4_2_bn, name='conv4_2_relu')
    ...
    concat_1 = Concatenate([deconv1_1, conv4_2],
    ...
    concat_2 = Concatenate([deconv2_1, conv3_2],
    ...
    concat_3 = Concatenate([deconv3_1, conv2_1],
    ...
    concat_4 = Concatenate([deconv4_1, conv1_1],
    ...
    soft_prob = softmax(pred_prob, name='pred_soft')
...
def unet_resnet(input_pred, input_img, output_channel, stage):
    ...
    input_pred_softmax = softmax(input_pred, name='softmax_ss' + stage)
    forground_input_pred = tf.expand_dims(input_pred_softmax[:, :, :, :, 1], axis=-1)
    input_concat = Concatenate([forground_input_pred, input_img], axis=-1)  # (1, 96, 96, 96, 2)
    ...
    input_cat =Concatenate([input_attention, input_attention, input_attention, input_attention,
    ...
    pool1_1 = MaxPooling3D(inputs=conv_bn_skip_1_1, pool_size=2, strides=2, name=stage + 'pool_1_1')
    ...
    pool1_1_cat = Concatenate([pool1_1, pool1_1], axis=-1)
    conv_bn_skip_2_1 = pool1_1_cat + conv_bn_2_2
    pool_2_1 = MaxPooling3D(inputs=conv_bn_skip_2_1, pool_size=2, strides=2, name=stage + 'pool2_2')
    ...
    pool_2_1_cat = Concatenate([pool_2_1, pool_2_1], axis=-1)
    conv_bn_skip_3_1 = conv_bn_3_3 + pool_2_1_cat
    pool3_1 = MaxPooling3D(inputs=conv_bn_skip_3_1, pool_size=2, strides=2, name=stage + 'pool3_1')
    ...
    pool3_1_cat = Concatenate([pool3_1, pool3_1], axis=-1)
    conv_bn_skip_4_1 = conv_bn_4_3 + pool3_1_cat
    pool4_1 = MaxPooling3D(inputs=conv_bn_skip_4_1, pool_size=2, strides=2, name=stage + 'pool4_1')
    ...
    pool4_1_cat = Concatenate([pool4_1, pool4_1], axis=-1)
    ...
    deconv_bn_1_1_cat = Concatenate([deconv_bn_1_1, deconv_bn_1_1], axis=-1)
    ...
    concat2 =Concatenate([deconv_bn_2_1, conv_bn_skip_3_1], axis=-1, name=stage + 'concat2')
    ...
    deconv_bn_2_1_cat = Concatenate([deconv_bn_2_1, deconv_bn_2_1], axis=-1)
    ...
    concat3 = Concatenate([deconv_bn_3_1, conv_bn_skip_2_1], axis=-1, name=stage + 'concat3')
    ...
    deconv_bn_3_1_cat = Concatenate([deconv_bn_3_1, deconv_bn_3_1], axis=-1)
    ...
    concat4 = Concatenate([deconv_bn_4_1, conv_bn_skip_1_1], axis=-1, name=stage + 'conca4_1')
    ...
    deconv_bn_4_1_cat = Concatenate([deconv_bn_4_1, deconv_bn_4_1], axis=-1)
    ...
    pred = conv3d(input=conv_bn_skip_9_1, output_chn=output_channel, kernel_size=1, stride=1, use_bias=True,
                  name=stage + 'pred')
    soft_prob_v = softmax(pred, name='pred_soft_v')
